# Solicitações de inclusão em times — `ELT73A-S22-2026-2`

Este repositório é o **ponto único de entrada** para solicitações de inclusão manual de alunos em times (grupos) da organização **`ELT73A-S22-2026-2`**.
